    	...
    	<div class="fluid-container">
        	<div class="content-row">
            	<div class="grid-12 text-center">
                	<h2 class="section-title text-uppercase">staying locations</h2>
        	...
        	<div class="grid-12 inner-sections">
                ...
                <div class="customer-feedbacks">
                	<div class="feedback-slides">
                    	<h4 class="light text-uppercase margin-zero">Jane Doe</h4>
                        <p class="dark-gray text-big">Stayed at Gazipur CHRD at a duplex room for 2 days</p>
                        <p class="quote times-new-roman text-italic">“I have visited many resorts across the country but none matches the quality and service of CHRD. To my opinion, when it comes to hospitality business, they are the best across the country.”</p>
                    </div>
                    <div class="feedback-slides">
                    	<h4 class="light text-uppercase margin-zero">Jane Doe</h4>
                        <p class="dark-gray text-big">Stayed at Gazipur CHRD at a duplex room for 2 days</p>
